...
public class Shoes extends Product 
{
  ...
  {
    // Use the productOptions to check for (and set) the number of stock for "Black" shoe sizes "6", "7","8", "9" and "10" 
    // Repeat for "Brown"
    // Use the nested ArrayList shoeStock
  ...
  {
    // Use the productOptions to check for (and reduce) the number of stock for "Black" shoe sizes etc
    // Use the nested ArrayList shoeStock
